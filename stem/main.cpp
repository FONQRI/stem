...
//#include "api/tocken_controller.h"
...
int main(int argc, char **argv)
{
	...
	auto j2 = R"(
  {
	...
	std::clog << j2["pi"] << std::endl;

	//	command_line_option_handler(argc, argv);
	std::string s{""};
	//	tocken_controller::get_tocken(s, s);

	stem_trace << "This is a trace severity message";
	stem_debug << "This is a debug severity message";
	stem_info << "This is an informational severity message";
	stem_warning << "This is a warning severity message";
	stem_error << "This is an error severity message";
	stem_fatal << "and this is a fatal severity message";
