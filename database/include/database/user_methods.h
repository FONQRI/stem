...
namespace stem::database
{

std::string create_user(std::string username, std::string password,
						std::string primary_phone_number, std::string app_name,
...
std::string get_user_access_level(std::string username, std::string password);

std::string update_user(std::string username, std::string password, optional_string update_username,
...
std::string create_token(std::string username, std::string password, std::string name,
						 std::string database_name, int valid_requests_number, int valid_read_size,
						 int valid_write_size, std::vector<std::string> access);

std::string update_key(std::string username, std::string password, std::string name,
...
std::string delete_user_key(std::string username, std::string password, std::string name);

std::string delete_user_keys(std::string username, std::string password);

std::string create_payment(std::string username, std::string password, int main_value,
