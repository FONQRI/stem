...
std::string find(std::string username, std::string database_name, json request);
...
std::string find_one_and_replace(std::string username, std::string database_name,
								 bsoncxx::types::b_document filter_document,
...
std::string distinct(std::string username, std::string database_name, std::string name_string,
					 bsoncxx::types::b_document filter_document,
					 boost::optional<bsoncxx::types::b_document> collation,
					 boost::optional<size_t> max_time);

void aggregate_oprate(mongocxx::pipeline &pipeline, bsoncxx::types::b_document doc);
std::string aggregate(std::string username, std::string database_name, optional_bool allow_disk_use,
					  optional_bool use_cursor, optional_bool bypass_document_validation,
					  optional_size max_time, optional_int batch_size, optional_ducument collation,
					  optional_string acknowledge_level, optional_string tag, optional_bool journal,
