// header
#include "database/user_methods.h"
										...
										optional_string_array emails)
{
	...
	try
	{
		...
		user_document.append(kvp("app_name", app_name));
 ...
 * successful or not
 */
std::string stem::database::create_token(std::string username, std::string password,
